# Handwritten `fused_conv2d3_add15` Local-First Runbook
...
`fused_conv2d3_add15` using the frozen best-staging DB and without touching
trusted current or launching any SSH / remote benchmark work.
