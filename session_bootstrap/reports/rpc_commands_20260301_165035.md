...
- generated_at: 2026-03-01T16:50:35+08:00
...
```bash
bash "/home/tianxing/tvm_metaschedule_execution_project/session_bootstrap/scripts/run_quick.sh" --env "/home/tianxing/tvm_metaschedule_execution_project/./session_bootstrap/reports/rpc_run_env_20260301_165035.env"
bash "/home/tianxing/tvm_metaschedule_execution_project/session_bootstrap/scripts/run_full_placeholder.sh" --env "/home/tianxing/tvm_metaschedule_execution_project/./session_bootstrap/reports/rpc_run_env_20260301_165035.env"
```

## 4) Client（一键首轮闭环入口）

```bash
bash "/home/tianxing/tvm_metaschedule_execution_project/session_bootstrap/scripts/run_rpc_first_round.sh" --env "/home/tianxing/tvm_metaschedule_execution_project/./session_bootstrap/reports/rpc_run_env_20260301_165035.env"
```
