...
- generated_at: 2026-03-06T19:59:31+08:00
- env_file: /home/tianxing/tvm_metaschedule_execution_project/session_bootstrap/config/rpc_tune_run_20260306_195752.env
- overall_status: PASS

| 检查项 | 状态 | 证据 |
|---|---|---|
| 目标场景：ARMv8 runner + 开发机 builder/orchestrator | 满足 | TARGET={"kind":"llvm","mtriple":"aarch64-linux-gnu","mcpu":"generic","mattr":["+neon","+crypto","+crc"],"num-cores":4}; DEVICE_KEY=armv8; RPC_TRACKER_HOST=100.121.87.73; RPC_TRACKER_PORT=9190 |
...
| 执行策略：单变量实验字段已定义 | 满足 | DAILY_SINGLE_CHANGE=RPC tune: laptop builder/tracker + phytium runner, total_trials=500 |
...
| RPC Tune：TUNE_TOTAL_TRIALS 已配置 | 满足 | TUNE_TOTAL_TRIALS=500 |
| RPC Tune：TUNE_OUTPUT_DIR 可写 | 满足 | TUNE_OUTPUT_DIR=./session_bootstrap/tmp/rpc_tune_output_20260306_195752; resolved=/home/tianxing/tvm_metaschedule_execution_project/./session_bootstrap/tmp/rpc_tune_output_20260306_195752 |
