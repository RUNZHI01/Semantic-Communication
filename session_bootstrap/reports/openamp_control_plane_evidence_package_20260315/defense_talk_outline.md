...
| 12 | 边界与下一步 | 不主张 `FIT-04/05`、`RESET_REQ/ACK`、deadline、sticky reset | [README.md](README.md) / [summary_report.md](summary_report.md) | 主动讲边界，减少被动追问 |
...
6. 最后主动讲 out-of-scope，避免评委把问题扩到未收口范围。
