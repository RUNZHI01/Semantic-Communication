...
| 执行策略：远端 TVM prep payload 参数完整 | 不满足 | uses_remote_payload=1; remote_mode=local; missing_or_placeholder=none; missing_artifacts=3; first_missing=/home/tianxing/TVM_LAST/finalWork/服务端/jscc-test/jscc/tvm_tune_logs/optimized_model.so; python_import_tvm=0; REMOTE_TVM_PYTHON=python3 |
