...
- generated_at: 2026-03-01T18:09:22+08:00
...
| 执行策略：单变量实验字段已定义 | 满足 | DAILY_SINGLE_CHANGE=change only tvm_002.py snr: REMOTE_SNR_BASELINE=10 -> REMOTE_SNR_CURRENT=12 (batch fixed at 1) |
