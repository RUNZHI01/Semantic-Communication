#!/usr/bin/env python3
"""Prepare staging-safe env files for handwritten mean4 work."""
...
DEFAULT_OUTPUT_ENV = (
    ...
    / "handwritten_fused_mean4_subtract4_divide4_multiply4_add14_relu3_profile.env"
)
DEFAULT_STAGING_ARCHIVE = (
    "/home/user/Downloads/jscc-test/"
    "jscc_staging_handwritten_fused_mean4_subtract4_divide4_multiply4_add14_relu3"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "fused_mean4_subtract4_divide4_multiply4_add14_relu3 candidate."
        )
    )
    parser.add_argument(
        "--base-env",
