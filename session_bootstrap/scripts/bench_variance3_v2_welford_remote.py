#!/usr/bin/env python3
"""Benchmark variance3 v2 (Welford single-pass) on Phytium Pi."""
...
class Mod:
    ...
    def fused_variance3_add10_tir_sqrt3(
        ...
        welford_mean = T.alloc_buffer((T.int64(1), T.int64(24), T.int64(1), T.int64(1)), "float32", scope="local")
        welford_M2 = T.alloc_buffer((T.int64(1), T.int64(24), T.int64(1), T.int64(1)), "float32", scope="local")
        ...
        for ax0, ax1, ax2, ax3, k2, k3 in T.grid(T.int64(1), T.int64(24), T.int64(1), T.int64(1), T.int64(128), T.int64(128)):
            with T.sblock("welford_update"):
                ...
                welford_mean[v_ax0, v_ax1, v_ax2, v_ax3] = welford_mean[v_ax0, v_ax1, v_ax2, v_ax3] + delta_old[0] / (T.Cast("float32", v_k2 * T.int64(128) + v_k3 + T.int64(1)))
        ...
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(24), T.int64(1), T.int64(1)):
            with T.sblock("compute"):
                ...
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.sqrt(welford_M2[v_i0, v_i1, v_i2, v_i3] / T.float32(16384.0) + T.float32(9.9999997473787516e-06))
...
print(json.dumps({"operator":"fused_variance3_add10_tir_sqrt3","version":"v2_welford","correctness":{"max_abs_diff":max_diff,"passed":max_diff<1e-3},"performance_us":{"median":median_us,"mean":float(np.mean(times)),"std":float(np.std(times)),"samples":30},"baseline_median_us":3562,"delta_pct":round((median_us-3562)/3562*100,2)}))
