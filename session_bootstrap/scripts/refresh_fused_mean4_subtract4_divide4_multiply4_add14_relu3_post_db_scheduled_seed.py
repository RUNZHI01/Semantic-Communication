#!/usr/bin/env python3
"""Refresh the checked-in post-db scheduled reference seed for mean4.
...
- it writes a checked-in mean4 scheduled reference seed without depending on
  any handwritten working-copy candidate state
"""
