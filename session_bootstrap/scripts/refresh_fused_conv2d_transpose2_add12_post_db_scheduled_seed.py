#!/usr/bin/env python3
"""Refresh the checked-in post-db scheduled reference seed for transpose2.
...
- it writes a checked-in transpose2 scheduled reference seed without depending
  on any handwritten working-copy candidate state
"""
