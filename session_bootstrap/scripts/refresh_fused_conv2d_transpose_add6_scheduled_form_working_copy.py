#!/usr/bin/env python3
"""Refresh the checked-in scheduled-form v1 working copy for transpose_add6.
...
def build_working_copy_manifest(
    *,
    ...
    return {
        ...
        "notes": [
            "This working copy is derived from the checked-in post-db scheduled reference seed so the first transpose_add6 edits start from a scheduled form.",
