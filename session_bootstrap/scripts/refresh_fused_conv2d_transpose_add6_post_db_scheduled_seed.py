#!/usr/bin/env python3
"""Refresh the checked-in post-db scheduled reference seed for transpose_add6.
...
- it writes a checked-in transpose_add6 scheduled reference seed without
  depending on any handwritten working-copy candidate state
"""
