#!/usr/bin/env python3
"""Refresh the checked-in post-db scheduled reference seed for fused_conv2d3_add15.
...
- it writes a checked-in fused_conv2d3_add15 scheduled reference seed without
