...
class DemoHTTPServerTest(unittest.TestCase):
    ...
    def test_root_serves_dashboard_entry_page(self) -> None:
        ...
        self.assertIn('id="missionPasswordCallout"', body)
        self.assertIn('id="missionPasswordHint"', body)
    ...
    def test_app_js_serves_dashboard_javascript(self) -> None:
        ...
        self.assertIn("jumpToPasswordEntry", body)
        self.assertIn('document.getElementById("missionPasswordCallout")', body)
        ...
        self.assertIn("data-password-cta", body)
