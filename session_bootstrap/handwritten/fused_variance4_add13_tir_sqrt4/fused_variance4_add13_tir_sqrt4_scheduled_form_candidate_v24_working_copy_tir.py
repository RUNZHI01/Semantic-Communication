# Editable scheduled-form candidate v24 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the checked-in scheduled-form v21 working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the checked-in v1/v2/v3/v4/v5/v6/v6a/v7/v8/v9/v10/v11/v12/v13/v14/v15/v16/v17/v18/v19/v20/v21/v22/v23
...
#
# New candidate goal:
# - start from the exact checked-in scalar-mean v21 branch
# - keep the scalar normalized-mean handoff and nested per-channel consume-now
#   loop shape from v21 intact
# - flatten the tiny reduction buffers `lv335_red` and `T_multiply_red` from
#   `(1, 12, 1, 1)` to `(12,)` so the scalar-mean branch also gets the tighter
#   12-channel indexing proved codegen-visible by v23
    ...
    def fused_variance4_add13_tir_sqrt4(
        ...
        for ax0, ax1, ax2, ax3 in T.grid(T.int64(1), T.int64(12), T.int64(1), T.int64(1)):
            with T.sblock("lv335_mean_local"):
                ...
                lv335_mean_local[0] = lv335_red[v_ax1] / T.float32(65536.0)
