# Editable scheduled-form candidate v11 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the checked-in scheduled-form v8 working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the checked-in v1/v2/v3/v4/v5/v6/v6a/v7/v8/v9/v10 candidates intact;
#   iterate here for the next narrow handwritten variance4 simplification
#   follow-up
# - do not treat this file as hook-facing or as performance evidence
#
# New candidate goal:
# - keep the v8 volatile one-element local round-trip that restored exact
#   equality intact
# - keep the same one-element local allocation, declared local buffer, and
#   float32 store/load boundary as v8
