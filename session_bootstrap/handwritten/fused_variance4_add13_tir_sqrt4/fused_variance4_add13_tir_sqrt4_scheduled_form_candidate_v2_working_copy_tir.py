# Editable scheduled-form candidate v2 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the frozen checked-in scheduled-form v1 working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the frozen v1 seed-aligned candidate intact; iterate here for the first
#   real handwritten variance4 edit
# - do not treat this file as hook-facing or as performance evidence
#
# New candidate goal:
# - remove the standalone 1x12x1x1 T_add_intermediate stage
# - fold the epsilon add directly into the final sqrt consumer
