# Editable scheduled-form candidate v4 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the checked-in scheduled-form v3 working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the checked-in v1/v2/v3 candidates intact; iterate here for the next
#   narrow handwritten variance4 simplification
# - do not treat this file as hook-facing or as performance evidence
#
# New candidate goal:
# - remove the standalone 1x12x1x1 T_divide mean stage
# - fold the mean /65536.0 directly into the T_subtract consumer
# - keep the v3 variance-normalization divide and epsilon-add-into-sqrt
#   simplifications intact
# - preserve both reductions, the T_subtract/T_multiply materialization, and
