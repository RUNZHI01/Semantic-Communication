# Editable scheduled-form candidate v18 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the checked-in scheduled-form v17 working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the checked-in v1/v2/v3/v4/v5/v6/v6a/v7/v8/v9/v10/v11/v12/v13/v14/v15/v16/v17
...
#
# New candidate goal:
# - start from the exact checked-in board-proven v17 state
# - keep the successful v17 normalized-mean handoff intact, then add one more
#   tiny reuse step: materialize the centered value once per element into a
#   one-element local buffer and reuse that staged subtract for the square
# - keep T_multiply_red at the v17 storage encoding and keep the existing
#   handle-free `.data`-volatile T_multiply_local round-trip intact
# - preserve the same two reductions, the same folded arithmetic intent, and
#   the same output signature as v17
