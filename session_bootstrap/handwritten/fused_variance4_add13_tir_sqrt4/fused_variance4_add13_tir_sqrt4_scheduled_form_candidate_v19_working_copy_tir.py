# Editable scheduled-form candidate v19 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the checked-in scheduled-form v18 working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the checked-in v1/v2/v3/v4/v5/v6/v6a/v7/v8/v9/v10/v11/v12/v13/v14/v15/v16/v17/v18
...
# - keep the successful v18 centered-value handoff intact, but tighten the
#   normalized-mean handoff to a one-element local buffer loaded once per
#   channel and reused across the full inner 256x256 loop
# - keep lv335_red explicitly local, keep T_multiply_red at the v18 storage
#   encoding, and keep the handle-free `.data`-volatile T_multiply_local
#   round-trip intact
# - preserve the same two reductions, the same folded arithmetic intent, and
#   the same output signature as v18
