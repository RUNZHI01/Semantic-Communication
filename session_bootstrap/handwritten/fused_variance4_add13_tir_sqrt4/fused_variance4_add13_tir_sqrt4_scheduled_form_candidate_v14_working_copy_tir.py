# Editable scheduled-form candidate v14 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the checked-in scheduled-form v13 working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the checked-in v1/v2/v3/v4/v5/v6/v6a/v7/v8/v9/v10/v11/v12/v13
...
#
# New candidate goal:
# - keep the v13 unit-axis cleanup and explicit `.data`-level volatile
#   one-element local round-trip intact
...
#   and the same output signature as v13
