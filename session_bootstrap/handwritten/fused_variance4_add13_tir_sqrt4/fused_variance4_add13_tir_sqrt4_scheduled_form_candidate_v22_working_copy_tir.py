# Editable scheduled-form candidate v22 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the checked-in scheduled-form v18 working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the checked-in v1/v2/v3/v4/v5/v6/v6a/v7/v8/v9/v10/v11/v12/v13/v14/v15/v16/v17/v18/v19/v20/v21
...
# - keep the successful v18 normalized-mean handoff shape intact instead of
#   scalarizing it
# - keep the centered-value T_subtract_local handoff and local T_multiply_red
#   storage intact
# - retime only the second phase so each per-channel mean is materialized and
#   then consumed through the full 256x256 square reduction before moving to
#   the next channel
