# Editable scheduled-form candidate v8 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the checked-in scheduled-form v7 working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the checked-in v1/v2/v3/v4/v5/v6/v6a/v7 candidates intact; iterate here
#   for the next narrow handwritten variance4 simplification follow-up
# - do not treat this file as hook-facing or as performance evidence
#
# New candidate goal:
# - keep the v7 volatile one-element local round-trip that restored exact
#   equality on top of v6
# - simplify the local storage declaration by dropping the redundant explicit
#   scope="local" from T.decl_buffer(...) while keeping the local allocation,
#   volatile attribute, and float32 store/load boundary intact
