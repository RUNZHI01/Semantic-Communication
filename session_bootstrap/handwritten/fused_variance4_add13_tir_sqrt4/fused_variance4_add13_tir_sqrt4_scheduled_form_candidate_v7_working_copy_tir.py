# Editable scheduled-form candidate v7 working copy for fused_variance4_add13_tir_sqrt4.
#
# Derived from the checked-in scheduled-form v6a working copy.
#
# Contract:
# - local-only diagnostic working copy
# - keep the checked-in v1/v2/v3/v4/v5/v6/v6a candidates intact; iterate here
...
#
# New candidate goal:
# - keep the v6a volatile one-element local round-trip that restored exact
#   equality on top of v6
# - remove the redundant explicit T.Cast("float32", ...) around the squared
#   centered-value local write
