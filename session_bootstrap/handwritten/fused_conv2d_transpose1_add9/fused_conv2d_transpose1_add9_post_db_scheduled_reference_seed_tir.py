# Schedule-preserving reference/edit seed for fused_conv2d_transpose1_add9.
#
# Source:
# - recovered from the post-database full-module path via MetaScheduleApplyDatabase
# - source operator global: fused_conv2d_transpose1_add9
...
# - distinct from the older raw pre-compile seed: ./session_bootstrap/handwritten/fused_conv2d_transpose1_add9/fused_conv2d_transpose1_add9_editable_seed_tir.py
#
# Contract:
...
class Module:
    ...
    def fused_conv2d_transpose1_add9(lv318: T.Buffer((T.int64(1), T.int64(48), T.int64(64), T.int64(64)), "float32"), param_0: T.Buffer((T.int64(48), T.int64(24), T.int64(3), T.int64(3)), "float32"), lv320: T.Buffer((T.int64(1), T.int64(24), T.int64(1), T.int64(1)), "float32"), T_add_intermediate: T.Buffer((T.int64(1), T.int64(24), T.int64(128), T.int64(128)), "float32")):
        ...
        for b_0_c_0_h_0_w_0_fused_fused_fused in T.parallel(T.int64(32), annotations={"pragma_auto_unroll_max_step": 32, "pragma_unroll_explicit": 1}):
            for b_1, c_1 in T.grid(T.int64(1), T.int64(6)):
                ...
                for h_1, w_1 in T.grid(T.int64(2), T.int64(2)):
                    for b_2_init, c_2_init, h_2_init, w_2_init, b_3_init, c_3_init, h_3_init in T.grid(T.int64(1), T.int64(1), T.int64(16), T.int64(1), T.int64(1), T.int64(4), T.int64(2)):
                        for w_3_fused_init in T.vectorized(T.int64(4)):
                            with T.sblock("compute_init"):
                                v_b = T.axis.spatial(T.int64(1), b_1 + b_2_init + b_3_init)
                                v_c = T.axis.spatial(T.int64(24), c_1 * T.int64(4) + c_2_init * T.int64(4) + c_3_init)
                    ...
                    for dc_0, dh_0, dw_0, b_2, c_2, h_2, w_2, dc_1, dh_1, dw_1, b_3, c_3, h_3 in T.grid(T.int64(12), T.int64(1), T.int64(1), T.int64(1), T.int64(1), T.int64(16), T.int64(1), T.int64(4), T.int64(3), T.int64(3), T.int64(1), T.int64(4), T.int64(2)):
                        for w_3_fused in T.vectorized(T.int64(4)):
                            with T.sblock("compute_update"):
                                v_b = T.axis.spatial(T.int64(1), b_1 + b_2 + b_3)
                                v_c = T.axis.spatial(T.int64(24), c_1 * T.int64(4) + c_2 * T.int64(4) + c_3)
            ...
            for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(24), T.int64(64)):
                for ax3_fused in T.vectorized(T.int64(8)):
                    with T.sblock("T_add"):
                        ...
                        v_ax2 = T.axis.spatial(T.int64(128), b_0_c_0_h_0_w_0_fused_fused_fused // T.int64(16) * T.int64(64) + ax2)
                        v_ax3 = T.axis.spatial(T.int64(128), b_0_c_0_h_0_w_0_fused_fused_fused % T.int64(16) * T.int64(8) + ax3_fused)
