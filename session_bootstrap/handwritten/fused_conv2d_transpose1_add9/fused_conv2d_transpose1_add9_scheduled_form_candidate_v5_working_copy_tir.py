# Editable scheduled-form candidate v5 working copy for fused_conv2d_transpose1_add9.
#
# Derived from:
...
# - this file intentionally starts as a clean clone of the accepted transpose1
#   P2+P4 state
# - apply the next genuinely different transpose1 edit here
# - keep the scheduled reference seed and the accepted v1/P2/P4 file frozen so
#   this scaffold can be refreshed or discarded safely
# - do not treat this file as hook-facing or as performance evidence
#
# Accepted baseline carried forward into this v5 scaffold:
...
#
# First real v5 locality/schedule edit:
# - keep data_dilate, data_pad, and kernel_transform materialized
# - keep the per-spatial-tile data_dilate/data_pad fill hoisted outside c_1
# - keep reusing each staged data tile across all three output-channel groups
# - change only the consumer loop placement from c_1 -> h_1/w_1 to
#   h_1/w_1 -> c_1
# - consume each staged spatial subtile across all three output-channel groups
#   before advancing to the next h_1/w_1 region
