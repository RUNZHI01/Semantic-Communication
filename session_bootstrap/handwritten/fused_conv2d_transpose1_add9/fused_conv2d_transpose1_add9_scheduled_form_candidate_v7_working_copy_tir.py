# Editable scheduled-form candidate v7 working copy for fused_conv2d_transpose1_add9.
#
# Derived from:
...
#   winning v4/v6 files frozen so this scaffold can be refreshed or discarded
#   safely
# - do not treat this file as hook-facing or as performance evidence
#
# Accepted baseline carried forward into this v7 scaffold:
...
# - keep the winning v6 h_1-stripe staging shape and c_1-before-w_1 consumer
#   family
#
# First real v7 locality/schedule edit:
# - keep the v6 one-h_1-at-a-time 34 x 10 data stripe
# - move data_dilate/data_pad staging inside dc_0 so only one 4-channel slice
#   of that stripe is prepared at a time
# - consume that staged 4-channel slice immediately across all three c_1 groups
#   and both w_1 positions before staging the next dc_0 slice
