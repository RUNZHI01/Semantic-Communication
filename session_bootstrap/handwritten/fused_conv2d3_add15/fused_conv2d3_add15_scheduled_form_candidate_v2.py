"""Checked-in local post-db candidate wrapper for fused_conv2d3_add15 v2.

This module points the local schedule-preserving seam at a new v2 working copy
that layers a kernel-repack experiment on top of the accepted v1 state without
mutating the accepted baseline files.
"""
