...
MODULE_PATH = (
    HANDWRITTEN_DIR / "fused_conv2d_transpose2_add12_scheduled_form_candidate_v1.py"
)
...
spec = importlib.util.spec_from_file_location(
    "fused_conv2d_transpose2_add12_scheduled_form_candidate_v1",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_transpose2_v1_test",
    SEAM_PROBE_PATH,
)
...
class FusedConv2dTranspose2Add12ScheduledFormCandidateV1Test(unittest.TestCase):
