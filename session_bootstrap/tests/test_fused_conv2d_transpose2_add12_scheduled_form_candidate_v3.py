...
MODULE_PATH = (
    HANDWRITTEN_DIR / "fused_conv2d_transpose2_add12_scheduled_form_candidate_v3.py"
)
...
spec = importlib.util.spec_from_file_location(
    "fused_conv2d_transpose2_add12_scheduled_form_candidate_v3",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_transpose2_v3_test",
    SEAM_PROBE_PATH,
)
...
class FusedConv2dTranspose2Add12ScheduledFormCandidateV3Test(unittest.TestCase):
    ...
    def test_seam_probe_can_load_the_v3_wrapper(self) -> None:
