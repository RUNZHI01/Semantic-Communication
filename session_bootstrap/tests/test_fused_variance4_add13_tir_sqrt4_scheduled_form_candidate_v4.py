...
MODULE_PATH = HANDWRITTEN_DIR / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v4.py"
WORKING_COPY_TIR_PATH = (
    HANDWRITTEN_DIR
    / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v4_working_copy_tir.py"
)

spec = importlib.util.spec_from_file_location(
    "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v4",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_variance4_v4_test",
    SEAM_PROBE_PATH,
)
...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV4Test(unittest.TestCase):
    def test_wrapper_reports_local_only_post_db_contract(self) -> None:
        ...
        self.assertEqual(
            ...
            "v4_mean_divide_stage_fused_into_subtract_on_top_of_v3_applied",
        )
