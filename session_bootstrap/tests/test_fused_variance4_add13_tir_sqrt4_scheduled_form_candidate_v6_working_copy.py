...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV6WorkingCopyTest(
    unittest.TestCase
):
    def test_working_copy_keeps_the_fifth_edit_local_and_isolated(self) -> None:
        ...
        self.assertIn("lv335[v_ax0, v_ax1, v_k2, v_k3]", text)
    ...
    def test_manifest_records_the_current_checked_in_v6_edit(self) -> None:
        ...
        self.assertIn(
            "remove the standalone T_multiply full-size stage",
