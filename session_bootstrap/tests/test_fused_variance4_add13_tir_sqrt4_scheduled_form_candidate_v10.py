...
MODULE_PATH = (
    HANDWRITTEN_DIR / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v10.py"
)
...
spec = importlib.util.spec_from_file_location(
    "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v10",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_variance4_v10_test",
    SEAM_PROBE_PATH,
)
...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV10Test(unittest.TestCase):
    def test_wrapper_reports_local_only_post_db_contract(self) -> None:
        ...
        self.assertEqual(metadata["candidate_version"], "v10_working_copy")
        self.assertEqual(
    ...
    def test_seam_probe_can_load_the_v10_wrapper(self) -> None:
