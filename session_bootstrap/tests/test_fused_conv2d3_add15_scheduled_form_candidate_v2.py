...
MODULE_PATH = HANDWRITTEN_DIR / "fused_conv2d3_add15_scheduled_form_candidate_v2.py"
...
spec = importlib.util.spec_from_file_location(
    "fused_conv2d3_add15_scheduled_form_candidate_v2",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_conv2d3_add15_v2_test",
    SEAM_PROBE_PATH,
)
...
class FusedConv2d3Add15ScheduledFormCandidateV2Test(unittest.TestCase):
    def test_wrapper_reports_local_only_post_db_contract(self) -> None:
        ...
        self.assertEqual(metadata["accepted_baseline"]["remote_median_ms"], 161.0)
