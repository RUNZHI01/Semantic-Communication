...
MODULE_PATH = HANDWRITTEN_DIR / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v9.py"
WORKING_COPY_TIR_PATH = (
    HANDWRITTEN_DIR
    / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v9_working_copy_tir.py"
)

spec = importlib.util.spec_from_file_location(
    "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v9",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_variance4_v9_test",
    SEAM_PROBE_PATH,
)
...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV9Test(unittest.TestCase):
    def test_wrapper_reports_local_only_post_db_contract(self) -> None:
        ...
        self.assertEqual(
            ...
            "v9_remove_volatile_scope_keep_explicit_local_roundtrip",
        )
