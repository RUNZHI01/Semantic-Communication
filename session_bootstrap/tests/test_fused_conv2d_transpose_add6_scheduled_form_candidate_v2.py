...
MODULE_PATH = (
    HANDWRITTEN_DIR / "fused_conv2d_transpose_add6_scheduled_form_candidate_v2.py"
)
...
spec = importlib.util.spec_from_file_location(
    "fused_conv2d_transpose_add6_scheduled_form_candidate_v2",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_transpose_add6_v2_test",
    SEAM_PROBE_PATH,
)
...
class FusedConv2dTransposeAdd6ScheduledFormCandidateV2Test(unittest.TestCase):
