...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV9WorkingCopyTest(
    unittest.TestCase
):
    def test_working_copy_keeps_explicit_local_roundtrip_but_drops_volatile_scope(
        self,
    ) -> None:
    ...
    def test_manifest_records_the_volatile_scope_removal_edit(self) -> None:
        ...
        self.assertIn(
            "remove only the volatile_scope attribute",
