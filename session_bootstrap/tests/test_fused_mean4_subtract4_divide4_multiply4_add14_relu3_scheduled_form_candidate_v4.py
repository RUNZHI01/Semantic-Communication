...
MODULE_PATH = (
    HANDWRITTEN_DIR
    / "fused_mean4_subtract4_divide4_multiply4_add14_relu3_scheduled_form_candidate_v4.py"
)
...
spec = importlib.util.spec_from_file_location(
    "fused_mean4_subtract4_divide4_multiply4_add14_relu3_scheduled_form_candidate_v4",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_mean4_v4_test",
    SEAM_PROBE_PATH,
)
...
class FusedMean4Subtract4Divide4Multiply4Add14Relu3ScheduledFormCandidateV4Test(
    unittest.TestCase
):
