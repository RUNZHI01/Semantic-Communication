...
MODULE_PATH = (
    HANDWRITTEN_DIR / "fused_conv2d_transpose1_add9_scheduled_form_candidate_v6.py"
)
...
spec = importlib.util.spec_from_file_location(
    "fused_conv2d_transpose1_add9_scheduled_form_candidate_v6",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_transpose1_v6_test",
    SEAM_PROBE_PATH,
)
...
class FusedConv2dTranspose1Add9ScheduledFormCandidateV6Test(unittest.TestCase):
    def test_wrapper_reports_local_only_post_db_contract(self) -> None:
        ...
        self.assertEqual(metadata["candidate_version"], "v6_working_copy")
        self.assertEqual(
    ...
    def test_seam_probe_can_load_the_v6_wrapper(self) -> None:
