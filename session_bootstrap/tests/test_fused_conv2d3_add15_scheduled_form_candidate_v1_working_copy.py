...
class FusedConv2d3Add15ScheduledFormCandidateV1WorkingCopyTest(unittest.TestCase):
    def test_working_copy_keeps_the_first_v1_edit_local_and_narrow(self) -> None:
        ...
        self.assertNotIn("conv2d_nchw_intermediate = T.alloc_buffer", text)
    ...
    def test_manifest_records_the_current_checked_in_v1_edit(self) -> None:
        ...
        self.assertEqual(
            ...
            "v1_bias_fusion_applied",
        )
        self.assertIn(
            "Bias is folded into the scheduled conv2d_nchw init/update path",
