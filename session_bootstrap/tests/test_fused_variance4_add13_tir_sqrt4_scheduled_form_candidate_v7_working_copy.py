...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV7WorkingCopyTest(
    unittest.TestCase
):
    def test_working_copy_keeps_v6a_roundtrip_but_drops_redundant_cast(self) -> None:
        ...
        self.assertNotIn("T_multiply_local[0] = T.Cast(", text)
    ...
    def test_manifest_records_the_cast_removal_edit(self) -> None:
        ...
        self.assertIn(
            "remove the redundant explicit T.Cast",
