...
MODULE_PATH = (
    HANDWRITTEN_DIR
    / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v15_working_copy_tir.py"
)
MANIFEST_PATH = HANDWRITTEN_DIR / "scheduled_form_candidate_v15_working_copy_manifest.json"
...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV15WorkingCopyTest(
    unittest.TestCase
):
    def test_working_copy_only_local_scopes_lv335_red(self) -> None:
        ...
        self.assertIn("T_multiply_red = T.alloc_buffer((T.int64(1), T.int64(12), T.int64(1), T.int64(1)))", text)
        ...
        spec = importlib.util.spec_from_file_location(
            "scheduled_form_candidate_v15_working_copy_tir",
            MODULE_PATH,
        )
    ...
    def test_manifest_records_the_lv335_red_local_scope_change(self) -> None:
        payload = json.loads(MANIFEST_PATH.read_text(encoding="utf-8"))

        self.assertEqual(payload["operator"], "fused_variance4_add13_tir_sqrt4")
        self.assertEqual(
            payload["working_copy_contract"]["path_kind"],
            "diagnostic_scheduled_form_candidate_v15_working_copy",
        )
        ...
        self.assertEqual(
            ...
            "v15_make_lv335_red_explicit_local_scope_keep_v14_roundtrip",
        )
        self.assertIn(
            "make only lv335_red explicitly T.alloc_buffer",
