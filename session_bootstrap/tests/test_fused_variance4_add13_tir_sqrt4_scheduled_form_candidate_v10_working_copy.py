...
MODULE_PATH = (
    HANDWRITTEN_DIR
    / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v10_working_copy_tir.py"
)
...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV10WorkingCopyTest(
    unittest.TestCase
):
    def test_working_copy_moves_volatile_scope_to_decl_buffer(self) -> None:
        ...
        self.assertIn('T.attr(T_multiply_local, "volatile_scope", 1)', text)
    ...
    def test_manifest_records_the_volatile_scope_retarget_edit(self) -> None:
        ...
        self.assertEqual(
            ...
            "v10_move_volatile_scope_attr_to_decl_buffer_keep_v8_roundtrip",
        )
        self.assertIn(
            "move the explicit volatile_scope marker",
