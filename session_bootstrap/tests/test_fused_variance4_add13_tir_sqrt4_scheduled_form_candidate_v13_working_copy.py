...
MODULE_PATH = (
    HANDWRITTEN_DIR
    / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v13_working_copy_tir.py"
)
MANIFEST_PATH = HANDWRITTEN_DIR / "scheduled_form_candidate_v13_working_copy_manifest.json"
...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV13WorkingCopyTest(
    unittest.TestCase
):
    def test_working_copy_reuses_unit_axes_for_the_folded_lv335_red_access(self) -> None:
        ...
        self.assertIn("lv335_red[v_ax0, v_ax1, v_ax2, v_ax3]", text)
        self.assertNotIn("lv335_red[v_ax0, v_ax1, T.int64(0), T.int64(0)]", text)
        ...
        spec = importlib.util.spec_from_file_location(
            "scheduled_form_candidate_v13_working_copy_tir",
            MODULE_PATH,
        )
    ...
    def test_manifest_records_the_unit_index_cleanup(self) -> None:
        ...
        self.assertEqual(
            ...
            "v13_replace_redundant_unit_indices_with_unit_axes_keep_v12_local_roundtrip",
        )
        self.assertIn(
            "replace only the redundant hardcoded T.int64(0), T.int64(0) lv335_red indices",
