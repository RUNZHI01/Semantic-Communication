...
MODULE_PATH = (
    HANDWRITTEN_DIR / "fused_conv2d_transpose2_add12_scheduled_form_candidate_v2.py"
)
WORKING_COPY_TIR_PATH = (
    HANDWRITTEN_DIR
    / "fused_conv2d_transpose2_add12_scheduled_form_candidate_v2_working_copy_tir.py"
)

spec = importlib.util.spec_from_file_location(
    "fused_conv2d_transpose2_add12_scheduled_form_candidate_v2",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_transpose2_v2_test",
    SEAM_PROBE_PATH,
)
...
class FusedConv2dTranspose2Add12ScheduledFormCandidateV2Test(unittest.TestCase):
    def test_wrapper_reports_local_only_post_db_contract(self) -> None:
        ...
        self.assertEqual(
            ...
            "p1_dilate_pad_fusion_on_top_of_v1_applied",
        )
    ...
    def test_seam_probe_can_load_the_v2_wrapper(self) -> None:
