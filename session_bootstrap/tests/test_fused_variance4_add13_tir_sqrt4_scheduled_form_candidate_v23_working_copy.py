...
MODULE_PATH = (
    HANDWRITTEN_DIR
    / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v23_working_copy_tir.py"
)
MANIFEST_PATH = HANDWRITTEN_DIR / "scheduled_form_candidate_v23_working_copy_manifest.json"
...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV23WorkingCopyTest(
    unittest.TestCase
):
    def test_working_copy_flattens_the_tiny_channel_buffers(self) -> None:
        ...
        self.assertIn("T.writes(lv335_mean_local[v_ax1])", text)
        self.assertIn("lv335[v_ax0, v_ax1, v_k2, v_k3] - lv335_mean_local[v_ax1]", text)
        ...
        spec = importlib.util.spec_from_file_location(
            "scheduled_form_candidate_v23_working_copy_tir",
            MODULE_PATH,
        )
    ...
    def test_manifest_records_the_flattened_channel_buffer_change(self) -> None:
        payload = json.loads(MANIFEST_PATH.read_text(encoding="utf-8"))

        self.assertEqual(payload["operator"], "fused_variance4_add13_tir_sqrt4")
        self.assertEqual(
            payload["working_copy_contract"]["path_kind"],
            "diagnostic_scheduled_form_candidate_v23_working_copy",
        )
        ...
        self.assertEqual(
            ...
            "v23_flatten_channel_buffers",
        )
        self.assertIn(
            "flatten the tiny per-channel buffers lv335_red, lv335_mean_local, and T_multiply_red",
