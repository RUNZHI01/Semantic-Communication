...
MODULE_PATH = (
    HANDWRITTEN_DIR / "fused_conv2d_transpose1_add9_scheduled_form_candidate_v5.py"
)
...
spec = importlib.util.spec_from_file_location(
    "fused_conv2d_transpose1_add9_scheduled_form_candidate_v5",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_transpose1_v5_test",
    SEAM_PROBE_PATH,
)
...
class FusedConv2dTranspose1Add9ScheduledFormCandidateV5Test(unittest.TestCase):
