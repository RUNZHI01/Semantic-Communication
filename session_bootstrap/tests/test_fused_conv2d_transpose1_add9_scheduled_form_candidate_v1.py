...
MODULE_PATH = (
    HANDWRITTEN_DIR / "fused_conv2d_transpose1_add9_scheduled_form_candidate_v1.py"
)
...
spec = importlib.util.spec_from_file_location(
    "fused_conv2d_transpose1_add9_scheduled_form_candidate_v1",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_v1_test",
    SEAM_PROBE_PATH,
)
...
class FusedConv2dTranspose1Add9ScheduledFormCandidateV1Test(unittest.TestCase):
