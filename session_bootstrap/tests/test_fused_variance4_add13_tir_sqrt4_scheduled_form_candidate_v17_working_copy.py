...
MODULE_PATH = (
    HANDWRITTEN_DIR
    / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v17_working_copy_tir.py"
)
MANIFEST_PATH = HANDWRITTEN_DIR / "scheduled_form_candidate_v17_working_copy_manifest.json"
...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV17WorkingCopyTest(
    unittest.TestCase
):
    def test_working_copy_stages_normalized_mean_once(self) -> None:
        ...
        self.assertIn("lv335_mean_local[v_ax0, v_ax1, v_ax2, v_ax3]", text)
        ...
        spec = importlib.util.spec_from_file_location(
            "scheduled_form_candidate_v17_working_copy_tir",
            MODULE_PATH,
        )
    ...
    def test_manifest_records_the_mean_reuse_change(self) -> None:
        ...
        self.assertEqual(
            ...
            "v17_stage_normalized_mean_once_keep_v15_storage_chain",
        )
        self.assertIn(
            "add a tiny lv335_mean_local handoff buffer",
