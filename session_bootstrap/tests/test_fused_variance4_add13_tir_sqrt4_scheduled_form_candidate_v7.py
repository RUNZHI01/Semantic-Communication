...
MODULE_PATH = HANDWRITTEN_DIR / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v7.py"
WORKING_COPY_TIR_PATH = (
    HANDWRITTEN_DIR
    / "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v7_working_copy_tir.py"
)

spec = importlib.util.spec_from_file_location(
    "fused_variance4_add13_tir_sqrt4_scheduled_form_candidate_v7",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_variance4_v7_test",
    SEAM_PROBE_PATH,
)
...
class FusedVariance4Add13TirSqrt4ScheduledFormCandidateV7Test(unittest.TestCase):
    def test_wrapper_reports_local_only_post_db_contract(self) -> None:
        ...
        self.assertEqual(metadata["candidate_version"], "v7_working_copy")
        self.assertEqual(
            metadata["candidate_status"],
            "v7_remove_redundant_cast_keep_v6a_volatile_roundtrip",
        )
    ...
    def test_seam_probe_can_load_the_v7_wrapper(self) -> None:
