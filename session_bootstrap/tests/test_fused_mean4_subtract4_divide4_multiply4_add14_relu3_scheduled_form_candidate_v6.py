...
MODULE_PATH = (
    HANDWRITTEN_DIR
    / "fused_mean4_subtract4_divide4_multiply4_add14_relu3_scheduled_form_candidate_v6.py"
)
...
spec = importlib.util.spec_from_file_location(
    "fused_mean4_subtract4_divide4_multiply4_add14_relu3_scheduled_form_candidate_v6",
    MODULE_PATH,
)
...
seam_spec = importlib.util.spec_from_file_location(
    "probe_transpose1_schedule_preserving_seam_mean4_v6_test",
    SEAM_PROBE_PATH,
)
...
class FusedMean4Subtract4Divide4Multiply4Add14Relu3ScheduledFormCandidateV6Test(
    unittest.TestCase
):
