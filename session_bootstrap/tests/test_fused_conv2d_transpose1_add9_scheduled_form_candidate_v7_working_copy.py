...
class FusedConv2dTranspose1Add9ScheduledFormCandidateV7WorkingCopyTest(
    unittest.TestCase
):
    def test_working_copy_keeps_the_v7_edit_local_and_isolated(self) -> None:
        text = MODULE_PATH.read_text(encoding="utf-8")

        self.assertIn("Accepted baseline carried forward into this v7 scaffold", text)
        self.assertIn("First real v7 locality/schedule edit", text)
        ...
        self.assertIn("T.int64(4), T.int64(34)", text)
        self.assertIn(
            "consume that staged 4-channel slice immediately across all three c_1 groups",
            text,
        )
    ...
    def test_manifest_records_the_current_checked_in_v7_scaffold_state(self) -> None:
        ...
        self.assertEqual(
            ...
            "v7_dc0_slice_staging_on_top_of_v6_applied",
        )
        self.assertIn(
            "one 4-channel by 34 x 10 slice is prepared at a time",
        ...
        self.assertEqual(payload["accepted_baseline"]["remote_median_ms"], 158.421)
