...
![图 1.1 系统总体架构图](Figure/图1.1/paper_fig_system_arch_cn_20260405.png)
...
![图 1.3 飞腾多核异构安全语义回传系统摘要图](Figure/图1.3/paper_fig_cover_summary_cn_20260405.png)
...
![图 2.1 GAN-based JSCC 系统结构图](Figure/图2.1/fig2_1_gan_jscc_ieee_v5.png)
...
![图 3.1 OpenAMP 控制状态机与消息转移图](Figure/图3.1/paper_fig_openamp_state_machine_cn_20260405.png)
...
![图 3.2 控制协议与消息时序](Figure/图3.2/paper_fig_control_message_sequence_cn_20260405.png)
...
![图 3.3 双模式边界图](Figure/图3.3/paper_fig3_3_dual_mode_boundary.png)
...
![图 3.4 Electron 演示界面证据映射图](Figure/图3.4/paper_fig_demo_workflow_cn_20260405.png)
...
![图 3.5 Electron 演示系统主界面截图](Figure/图3.5/paper_fig_demo_dashboard_ui_cn_20260405.png)
...
![图 3.6 Electron 演示系统关键细节界面](Figure/图3.6/paper_fig_demo_detail_panels_cn_20260405.png)
...
![图 4.1 TVM 编译优化流程图](Figure/图4.1/paper_fig4_1_tvm_opt_flow_strict_ieee_v3.png)
...
![图 4.2 关键算子图内性能差异与热点占比](Figure/图4.2/paper_fig4_2_operator_hotspot_strict_ieee.png)
...
![图 4.3 纯推理与串行重建性能对比](Figure/图4.3/paper_fig4_3_big_little_pipeline_strict_ieee_v2.png)
...
![图 4.4 TVM trusted current 的多 SNR 鲁棒性](Figure/图4.4/paper_fig4_4_snr_robustness_strict_ieee_v2.png)

> **图 4.4** TVM trusted current 的多 SNR 鲁棒性（真机 300 张图像复测）

重建时间在 228~234 ms/image 范围内保持稳定，对 SNR 变化不敏感；图像质量随信道条件改善而稳步提升。

![图 4.5 重建效果对比](Figure/图4.5/paper_fig_reconstruction_gallery_cn_20260405.png)
...
![图 4.6 TVM 主线结果总览](Figure/图4.6/paper_fig4_6_tvm_overview_ieee_v3.png)
...
![图 4.9 异构大小核流水线性能对比](Figure/图4.9/fig_big_little_pipeline.png)
...
![图 4.7 MNN 架构示意图](Figure/图4.7/fig_mnn_arch.png)
...
![图 4.8 MNN 动态尺寸路线关键配置对比](Figure/图4.8/fig_mnn_benchmark_optimized.png)
...
![图 4.10 双引擎部署定位与端侧性能关系](Figure/图4.10/fig_framework_positioning.png)
...
![图 4.11 传统压缩与语义通信的弱网对比](Figure/图4.11/fig_semantic_vs_traditional.png)
...
![图 5.1 系统关键性能跃迁与最新 OpenAMP 三核 handwritten follow-up 定位](Figure/图5.1/paper_fig_performance_ladder_cn_20260406.png)
...
![图 5.2 答辩证据包结构图](Figure/图5.2/paper_fig_evidence_bundle_cn_20260405.png)
...
![图 5.3 弱网安全语义回传系统闭环总览图](Figure/图5.3/paper_fig_system_closure_overview_cn_20260405.png)
